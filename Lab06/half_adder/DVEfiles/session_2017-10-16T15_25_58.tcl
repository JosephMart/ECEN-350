...
#<Session mode="Full" path="/home/ugrads/j/josephmart/git/ECEN_350/Lab06/half_adder/DVEfiles/session.tcl" type="Debug">
...
if { ![gui_is_db_opened -db {/home/ugrads/j/josephmart/git/ECEN_350/Lab06/half_adder/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/ugrads/j/josephmart/git/ECEN_350/Lab06/half_adder -nosource
}
}
...
catch {gui_list_select -id ${Hier.1} {HalfAddTest_v}}
...
gui_list_show_data -id ${Data.1} {HalfAddTest_v}
